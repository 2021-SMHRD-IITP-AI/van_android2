...
public class user_record_modify extends AppCompatActivity {
    ...
    private TextView urm_pname, urm_pcompany, urm_otcetc, urm_mysymptom, urm_date_start, urm_date_end,
            urm_takingtime1, urm_takingtime2, urm_takingtime3, urm_takingtime4, urm_takingtime5, urm_alarmtime, urm_alarmday,
            urm_height, urm_weigth, urm_myrecord;
